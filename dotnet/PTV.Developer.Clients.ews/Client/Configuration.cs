...
namespace PTV.Developer.Clients.ews.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.staging.myptv.com/ews/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.staging.myptv.com/ews/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.staging.myptv.com/ews/v1") : this()
        {
        ...
        {
            string report = "C# SDK (PTV.Developer.Clients.ews) Debug Report:\n";
